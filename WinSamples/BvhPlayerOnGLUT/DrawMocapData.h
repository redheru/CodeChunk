...
public:
	...
	~DrawMocapData(){ /*delete [] vertices; delete [] normals; delete [] indices; glDeleteBuffers(3, buffers);*/}
...
private:
	...
	double alpha_;
    bool isDrawCylinderModel_;
	int indicesArraySize_;
...
public:
	...
	bool getIsDrawLocalAxes(){return isDrawLocalAxes;}
...
private:
	...
	void DrawBone(klVec3 p, klVec3 v1, klVec3 v2, klVec3 v3, float length, float radius);
	void DrawVBO();

...
class GLUTShadow; //前方宣言(クラスの参照のため)
class GLUTShadow_GLSL_VBO; //前方宣言(クラスの参照のため)
...
// >アクセッサ
	...
	GLUTShadow_GLSL_VBO* getGLUTShadow(){return m_shadow;}
	bool getIsEnableShadow(){return m_isEnableShadow;}
...
// >ミューテータ
	...
	void setIsEnableShadow(bool flag){m_isEnableShadow = flag;}
};
